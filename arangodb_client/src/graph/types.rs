...
use arangodb_core::arango::protocol::{FIELD_ENTITY_ID, FIELD_ENTITY_KEY,
    FIELD_ENTITY_REVISION, FIELD_EDGE_DEFINITIONS, FIELD_NAME,
    FIELD_ORPHAN_COLLECTIONS};
use arangodb_core::arango::protocol::{FIELD_NUMBER_OF_SHARDS, FIELD_REPLICATION_FACTOR};
use arangodb_core::arango::protocol::{FIELD_IS_SMART, FIELD_SMART_GRAPH_ATTRIBUTE};
