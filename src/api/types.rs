...
mod tests {
    ...
    fn convert_f64_value_to_string() {
        ...
        let string = value.to_string();
        assert_eq!("0.0002982838917110001", string);
    }
    ...
    fn convert_string_vec_value_to_string() {
        ...
        let string = value.to_string();
        assert_eq!(r#"["a","wooxoi xcvakljs","eirwo"]"#, string)
    }
    ...
    fn convert_f32_vec_value_to_string() {
        ...
        let string = value.to_string();
        assert_eq!(r#"[3.1415927,0.001]"#, string)
    }
    ...
    fn convert_f64_vec_value_to_string() {
        ...
        let string = value.to_string();
        assert_eq!(r#"[2984191233650.1]"#, string)
    }
