...
use arangodb_core::api;
use arangodb_core::api::auth::{Authentication, Credentials, Jwt};
use arangodb_core::api::method::{Method, Operation, Prepare, RpcReturnType};
use arangodb_core::arango::protocol::PATH_DB;
...
mod tests {
    ...
    use arangodb_core::api::auth::{Authentication, Credentials};
    use arangodb_core::api::method::{Parameters, Prepare};
    use super::*;
